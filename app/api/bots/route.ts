...
export async function POST(request: Request) {
  try {
    ...
    if (strategy?.strategy_key === "crypto-shares.continuation.btc5m" || strategy?.strategy_key === "crypto-shares.cheapshare.flip" || strategy?.strategy_key === "crypto-shares.scalper.rejection" || strategy?.strategy_key === "crypto-shares.forecast.confluence")
      throw new HttpError(
        409,
