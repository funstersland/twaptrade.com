...
const services = [
  {id:"e7f62ce3-27fc-4d6c-bf8c-4ac06809eed3",name:"twaptrade.com",startCommand:"node server.js",healthcheckPath:"/api/health",healthcheckTimeout:120,preDeployCommand:["node scripts/prepare-cheapshare-database.mjs"]},
